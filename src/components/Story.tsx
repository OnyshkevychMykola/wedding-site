    ...
    <section className={styles.section}>
      <motion.div className={styles.container} {...fadeIn}>
        ...
        <p className={styles.text}>
          Після успішного першого сезону під назвою «Побачення»,
          кількох сезонів «Спільне життя» та численних спецвипусків
          ми раді представити довгоочікуване продовження:
        </p>

        <p className={styles.movieTitle}>«Весілля. Назавжди разом».</p>
        ...
        <p className={styles.invite}>
          Запрошуємо на показ найважливішого епізоду нашого життя — нашого весілля. 🍾
        </p>
